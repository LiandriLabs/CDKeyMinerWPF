...
namespace CDKeyMiner
{
    public class NBMiner : IMiner
    {
        ...
        public void Start(Credentials credentials)
        {
            ...
            if (algo == Algo.ETH)
            {
                nbminerProc.StartInfo.Arguments = $"-a ethash -o stratum+ssl://app.cdkeyminer.com:10000 -u {credentials.Username} -log -api 127.0.0.1:22333";
            }
            else if (algo == Algo.ETC)
            {
                nbminerProc.StartInfo.Arguments = $"-a etchash -o stratum+ssl://app.cdkeyminer.com:10001 -u {credentials.Username} -log -api 127.0.0.1:22333";
            }
            else
            {
